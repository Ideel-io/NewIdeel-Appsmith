        ...
        <div class="content">
            <div>
                ...
                <br> Client : ${Family.findFamilyMember(SelectProfileResiliation.selectedOptionValue).lastname} ${Family.findFamilyMember(SelectProfileResiliation.selectedOptionValue).firstname}
								<br> Date de naissance : ${moment(Family.findFamilyMember(SelectProfileResiliation.selectedOptionValue).birthdate).format("DD/MM/YYYY")}
                ...
                <br>
                <br> À compter de cette date, l'intégralité du contrat sera assuré chez ${user_new_partner.selectedOptionLabel}
