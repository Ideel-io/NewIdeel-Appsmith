export default {
	...
	async addHousing() {
		try{
			...
			showModal(RelanceScraperHealth.name);
		} catch(error){
	...
	getDefaultHousingSelectionValue() {
		if (getLastHealthRunData.data && getLastHealthRunData.data.data.getLastHealthRunData.userHealthInfo.housing_selection_other){
			return getLastHealthRunData.data.data.getLastHealthRunData.userHealthInfo.housing_selection_other
		}
		
		if (utils.getAnswer(getProcedureDetails.data.data.getProcedureDetails, "housing_selection_other")) {
			return utils.getAnswer(getProcedureDetails.data.data.getProcedureDetails, "housing_selection_other");
		}
