export default {	
 ...
 calculateAnnualPrice() {
  ...
  let finalPrice = (annualPrice * 0.87 * commissionPercentage) / 100;
    ...
    <body>
        <div class="content">
            <div>
                ...
                <br> Client : ${FamilyMember.findFamilyMember(SelectProfileResiliation.selectedOptionValue).lastname} ${FamilyMember.findFamilyMember(SelectProfileResiliation.selectedOptionValue).firstname}
